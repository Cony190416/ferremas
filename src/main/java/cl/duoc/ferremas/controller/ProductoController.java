...
// DTO para productos con precios
class ProductoConPreciosDTO {
    ...
    public ProductoConPreciosDTO(Producto producto, List<Precio> precios) {
...
public class ProductoController {
    ...
    // Obtener todos los productos con precios incluidos (para el frontend)
    @GetMapping("/con-precios")
    public ResponseEntity<List<ProductoConPreciosDTO>> obtenerTodosConPrecios() {
        List<Producto> productos = productoService.obtenerTodos();
        
        List<ProductoConPreciosDTO> productosConPrecios = productos.stream()
            .map(producto -> {
                List<Precio> precios = precioService.obtenerPreciosPorCodigoProducto(producto.getCodigo());
                return new ProductoConPreciosDTO(producto, precios);
            })
